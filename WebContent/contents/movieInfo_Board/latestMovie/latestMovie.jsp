...
<body>
						...
						<table>
							<tr>
								<td class="thumnail" id="thumnail1">
									...
									<img src="#" style='z-inex:10'
									 style="cursor:pointer" onclick="viewDetails();"> 
    ...
    <script>
    	function viewDetails(){
    		window.open("<%= request.getContextPath()%>/contents/movieInfo_Board/viewDetails/viewDetails.jsp","viewDetails",
    				"scrollbars=yes,width=800,height=1300, left=250" )
    	}
    </script>
