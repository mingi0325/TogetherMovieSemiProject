...
<body>
    ...
    <main>
      ...
      <!--   <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarColor03" aria-controls="navbarColor03" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="cinema">
              <div class="cinema-title">홍대 메가박스</div>
              <div class="cinema-subTitle dongDaeMoon-subtitle">핵인싸들의 놀이터 홍대! 홍대입구역 1번 출구 50M 위치.</div>    
        </div>
        <div class="cinema-FacilityInfo">
            ...
            <div class="location-logo">
                <i class="fas fa-map-marker-alt"><a class="location-logo__click" href="../mapAPI/hongDaeMap/hongDaeMap.html">실시간 길찾기</a></i>
            </div> 
        </div>
                ...
                <div class=parking-guide>
                    ...
                    <div class="parking-ex parking-ex__adjustment">
                        ...
                        <div class="parking-ex__detail dongDaeMoon-ex__detail">
                            <ul>
                                <li>아일렉스 건물 內 지하2층 ~ 지하4층 주차장 이용</li>
                ...
                <div class="parking-guide parking-confirm dongDaeMoon-parking-confirm" >
                    ...
                    <div class=parking-ex>
                        ...
                        <div class=parking-ex__detail>
                            <ul>
                                <li>7층 주차인증 PC에서 1시간 무료쿠폰 등록,출차 시 정산</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="parking-fee-box ">
                        ...
                        <div class=parking-fee__detail>
                            <ul>
                                ...
                                <li>영화 관람시 1시간 무료, 이후 10분당 1,000원 부과</li>
                                <li>주차공간 협소 및 교통혼잡으로 가급적 대중교통을 이용해 주시기 바랍니다. (2호선, 공항철도, 경의중앙선 홍대입구역 1번 출구)</li>
                                <li>주차장 운영규정은 메가박스와는 무관하며 건물관리 내부규정에 따라 운영이 되고 있습니다./li>
                            </ul>
                        </div>
                    </div>
                </div>
           ...
           <div class="publicTransport-bigBox subway-mainbox" >
            ...
            <div class= publicTransport-box>
                ...
                <div class=subway-line>
                    <ul>
                        <li>지하철2호선 '홍대입구역' 하차 -> 지하철 1번 출구 이용</li>
                        <li>공항철도 '홍대입구역' 하차 -> 지하철 1번 출구 이용</li>
                        <li>지하철 경의중앙선 '홍대입구역' 하차 -> 지하철 1번 출구 이용</li>
                    </ul>
                </div>
            </div>
       </div>
